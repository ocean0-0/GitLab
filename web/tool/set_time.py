...
def set_time(ip, port, hour, minute):
	...
	try:
		s.sendall(packet.pack_data(0, 0x10000, {'set_time':[hour, minute]}))
	except:
		s.close()
		return
...
def main():
	set_time(sys.argv[1], int(sys.argv[2]), int(sys.argv[3]), int(sys.argv[4]))
